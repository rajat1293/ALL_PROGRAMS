...
#include <string.h>
 /*
 THE PROGRAM CALCULATES THE LONGEST SUBSTRING WHICH IS A PALINDROME IT PRINTS THE LATEST ONE AS THE
 PALINDROME  IE THE CASE WHERE WE HAVE TWO STRINGS OF SAME LENGTH
 */
