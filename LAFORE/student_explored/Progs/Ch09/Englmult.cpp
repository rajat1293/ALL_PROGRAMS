...
class Lumber : public Type, public Distance
   ...
   public:                               //constructor (no args)
      Lumber() :  quantity(0), price(0.0),Distance(),Type()      
         {  }
					 //constructor (6 args)
...
int main()
   ...
   //the only harm of not calling a coastructor is that the values will not be initaialised 
   //the no arg constructor gets clalled themselves ...WE NEED NOT CALL THEM EXPLICITLY
   //THE ORDER IN WHICH THEY ARE CALLED DEPENDS ON THE ORDER IN WHICH THEY ARE PART OF
   //THE CLASS THEY ARE THE PARENTS...
