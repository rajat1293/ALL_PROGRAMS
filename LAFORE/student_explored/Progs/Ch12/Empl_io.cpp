...
//TO WRITE SEVERAL OBJECTS AT THE SAME TIME ....
//in the rewobj.cpp we read each obj open file and write then closse it,,it is highly inefficient 
// to do this ..instead we can use a static function which can access the objects through
// pointers ...now the objects are of diffrent types as of inheritance used ..
//we can use virtaul fuctions but how to get the size of the object ,,here comes the 
//role of typeid....
//array of pointers employee* employee::arrap[MAXEM]; is created...
// ADD ,DISPLAY,READ AND WRITE ALL ARE STATIC  AS THEY ARE FOR THE WHOLE PROGRAM
//A STATIC DATA N KEEPS THE CURRENT NUMBER OF THE EMPLOYEE...
//
