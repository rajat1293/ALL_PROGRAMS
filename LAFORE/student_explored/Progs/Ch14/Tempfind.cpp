...
int main()
   ...
   return 0;
	...
	//cant just use find(lonarr,in,6) or for that matter any other type 
	//the same task can be fulfilld with macros but the problems are
	//no type cheking,not if retunred is assigned to same type
