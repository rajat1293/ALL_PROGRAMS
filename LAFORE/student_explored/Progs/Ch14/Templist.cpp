...
int main()
   ...
   //ACTUALY IT IS REQUIRED TP MAKE THE BOTH AS 'TYPE'
   //NOW FORGET THAT LINK IS USER DEFINED ..IT IS A DATA TYPE AND THINK IT WE WANT A MEMBER DATA OF ANY TYPE 
   //WE WANT SO IT IS A TEMPLATE
   //here WE HAVE STORED PRIMITIVE DATA TYPE ,BUT IT IS ALSO POSSIBLE TO STORE USER FEFINED DATA TYPS ..
   //BUT WITH A CAVEAT
